    ...
    <div className="min-h-screen grid md:grid-cols-2 bg-background">
        ...
        <div className="mx-auto w-full max-w-md space-y-6">
          <div className="text-center mb-8">
            <div className="inline-flex items-center">
              <span className="text-primary text-3xl font-bold mr-1">Литера</span>
      ...
      <div className="hidden md:flex bg-gradient-to-r from-primary to-secondary items-center justify-center text-white p-8">
        <div className="max-w-md space-y-6">
          ...
          <p className="text-xl font-serif">Платформа для писателей, где рождаются шедевры</p>
          <div className="space-y-4">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p>Систематизируйте ваш творческий мир с помощью карточек персонажей, локаций и событий</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <div className="bg-white/20 p-2 rounded-full">
