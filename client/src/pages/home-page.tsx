    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto p-4 md:p-6">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl md:text-3xl font-bold">Добро пожаловать, {user?.username || 'автор'}!</h1>
        ...
        <Tabs defaultValue="my-books" className="space-y-6">
          ...
          <TabsContent value="my-books">
            {isLoading ? (
                  ...
                  <Card key={book.id} className="overflow-hidden hover:shadow-md transition-shadow">
                    ...
                    <CardContent className="pb-2">
                      <p className="text-muted-foreground text-sm">
                        {book.chapterCount || 0} глав • {book.wordCount || 0} слов
                      </p>
                    </CardContent>
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-medium mb-2">У вас пока нет книг</h3>
                <p className="text-muted-foreground mb-6">Начните свой творческий путь, создав первую книгу</p>
          ...
          <TabsContent value="published">
            {isLoading ? (
                  ...
                  .map((book) => (
                    <Card key={book.id} className="overflow-hidden hover:shadow-md transition-shadow">
                      <CardHeader className="pb-2">
                        <CardTitle className="text-xl">{book.title}</CardTitle>
                        <CardDescription>
                          Опубликовано: {formatDate(book.publishedAt || book.updatedAt || book.createdAt)}
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="pb-2">
                        <p className="text-muted-foreground text-sm">
              ...
              <div className="text-center py-12">
                <BookOpenIcon className="h-12 w-12 mx-auto text-muted-foreground mb-4" />
                <h3 className="text-xl font-medium mb-2">У вас пока нет опубликованных книг</h3>
                <p className="text-muted-foreground mb-6">Опубликуйте свою книгу, чтобы поделиться ею с миром</p>
              </div>
            )}
          </TabsContent>
        </Tabs>
